...
echo "Fazendo push para o reposit\'f3rio GitHub..."\
git add .\
git commit -m "Atualiza\'e7\'e3o autom\'e1tica"\
git push https://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@github.com/tiagorocheta/teste-api-e2e.git\
chmod +x push-git.sh\
}